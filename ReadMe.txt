...
Questions or suggestions: hit me on Twitter @binaryanalogue (the handle is a reference to my alleged robot/code-like nature)
...
- Click PowerPoint Add-ins in the drop-down next to Manage: at the bottom
- Click Go...
- Select Blox under "Available Add-ins:"
- Click Remove

You can further delete the file now by:
- Clicking "Add New..."
- Selecting and deleting the Blocks.ppam file
